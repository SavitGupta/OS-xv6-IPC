...
80101ed8:	68 22 77 10 80       	push   $0x80107722
...
80103684:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103687:	c7 40 14 92 56 10 80 	movl   $0x80105692,0x14(%eax)
  p->context = (struct context*)sp;
...
8010403b:	68 3b 79 10 80       	push   $0x8010793b
...
80104068:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
      state = "???";
...
801040ea:	68 38 76 10 80       	push   $0x80107638
...
80104305:	68 43 76 10 80       	push   $0x80107643
8010430a:	e8 81 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010430f:	83 ec 0c             	sub    $0xc,%esp
80104312:	68 5a 76 10 80       	push   $0x8010765a
...
801043f7:	68 61 76 10 80       	push   $0x80107661
...
8010444c:	68 69 76 10 80       	push   $0x80107669
...
8010486c:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
...
80104890:	68 71 76 10 80       	push   $0x80107671
...
801049e4:	68 18 77 10 80       	push   $0x80107718
...
801049fc:	68 17 77 10 80       	push   $0x80107717
...
80104a15:	68 0b 77 10 80       	push   $0x8010770b
...
80104a2a:	68 1a 77 10 80       	push   $0x8010771a
80104a2f:	e8 5c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a34:	83 ec 0c             	sub    $0xc,%esp
80104a37:	68 fc 76 10 80       	push   $0x801076fc
...
80104e29:	58                   	pop    %eax
80104e2a:	5a                   	pop    %edx
80104e2b:	68 18 77 10 80       	push   $0x80107718
...
80104e44:	68 17 77 10 80       	push   $0x80107717
...
80105490 <sys_sharemem>:

int sys_sharemem(void)
{
...
8010549c:	e8 bf f2 ff ff       	call   80104760 <argint>
801054a1:	83 c4 10             	add    $0x10,%esp
801054a4:	85 c0                	test   %eax,%eax
801054a6:	78 20                	js     801054c8 <sys_sharemem+0x38>
    return -1;
  }
  if(create_share_mem((char *)addr) == -1){
801054a8:	83 ec 0c             	sub    $0xc,%esp
801054ab:	ff 75 f4             	pushl  -0xc(%ebp)
801054ae:	e8 5d 1a 00 00       	call   80106f10 <create_share_mem>
801054b3:	83 c4 10             	add    $0x10,%esp
801054b6:	83 f8 ff             	cmp    $0xffffffff,%eax
801054b9:	0f 94 c0             	sete   %al
    return -1;
  }
  return 0;
801054bc:	c9                   	leave  
...
801054e3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054e6:	e8 25 e7 ff ff       	call   80103c10 <exit>
...
801054f3:	5d                   	pop    %ebp
  return wait();
801054f4:	e9 57 e9 ff ff       	jmp    80103e50 <wait>
...
8010550c:	e8 4f f2 ff ff       	call   80104760 <argint>
...
8010551e:	e8 7d ea ff ff       	call   80103fa0 <kill>
...
8010555d:	e8 fe f1 ff ff       	call   80104760 <argint>
...
801055ad:	e8 ae f1 ff ff       	call   80104760 <argint>
...
801055c5:	e8 86 ed ff ff       	call   80104350 <acquire>
  ticks0 = ticks;
...
801055ed:	e8 9e e7 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
...
80105615:	e8 f6 ed ff ff       	call   80104410 <release>
      return -1;
...
80105638:	e8 d3 ed ff ff       	call   80104410 <release>
  return 0;
...
801056ee:	00 00 ef 
  initlock(&tickslock, "time");
801056f1:	68 5d 77 10 80       	push   $0x8010775d
...
80105770:	ff 24 85 04 78 10 80 	jmp    *-0x7fef87fc(,%eax,4)
...
801057d5:	68 c0 77 10 80       	push   $0x801077c0
...
80105917:	68 68 77 10 80       	push   $0x80107768
...
801059b5:	68 8c 77 10 80       	push   $0x8010778c
801059ba:	e8 a1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059bf:	83 c4 14             	add    $0x14,%esp
801059c2:	68 62 77 10 80       	push   $0x80107762
...
80105abc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105abf:	bb 84 78 10 80       	mov    $0x80107884,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801066cd:	68 8c 78 10 80       	push   $0x8010788c
...
801066fc:	73 6e                	jae    8010676c <deallocuvm.part.0+0x8c>
801066fe:	89 d6                	mov    %edx,%esi
80106700:	eb 45                	jmp    80106747 <deallocuvm.part.0+0x67>
...
8010670d:	74 2e                	je     8010673d <deallocuvm.part.0+0x5d>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010670f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106715:	74 60                	je     80106777 <deallocuvm.part.0+0x97>
        panic("kfree");
      else if(pa == (int)share_mem_pa){
80106717:	39 15 c0 a5 10 80    	cmp    %edx,0x8010a5c0
8010671d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106720:	74 1b                	je     8010673d <deallocuvm.part.0+0x5d>
        continue;
      }
      char *v = P2V(pa);
      kfree(v);
80106722:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106725:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010672b:	52                   	push   %edx
8010672c:	e8 ef bb ff ff       	call   80102320 <kfree>
      *pte = 0;
80106731:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106734:	83 c4 10             	add    $0x10,%esp
80106737:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
8010673d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106743:	39 f3                	cmp    %esi,%ebx
80106745:	73 25                	jae    8010676c <deallocuvm.part.0+0x8c>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106747:	31 c9                	xor    %ecx,%ecx
80106749:	89 da                	mov    %ebx,%edx
8010674b:	89 f8                	mov    %edi,%eax
8010674d:	e8 7e fe ff ff       	call   801065d0 <walkpgdir>
    if(!pte)
80106752:	85 c0                	test   %eax,%eax
80106754:	75 b2                	jne    80106708 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106756:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
8010675c:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106762:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106768:	39 f3                	cmp    %esi,%ebx
8010676a:	72 db                	jb     80106747 <deallocuvm.part.0+0x67>
    }
  }
  return newsz;
}
8010676c:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010677a:	68 26 72 10 80       	push   $0x80107226
8010677f:	e8 0c 9c ff ff       	call   80100390 <panic>
...
80106999:	e8 b2 fc ff ff       	call   80106650 <mappages>
  memmove(mem, init, sz);
...
801069b9:	68 d1 78 10 80       	push   $0x801078d1
...
80106a13:	e8 b8 fb ff ff       	call   801065d0 <walkpgdir>
...
80106af4:	e8 57 fb ff ff       	call   80106650 <mappages>
...
80106b1d:	68 09 79 10 80       	push   $0x80107909
...
80106b53:	68 21 79 10 80       	push   $0x80107921
...
80106b70:	e8 6b fb ff ff       	call   801066e0 <deallocuvm.part.0>
      kfree(mem);
...
80106baa:	e8 31 fb ff ff       	call   801066e0 <deallocuvm.part.0>
...
80106bd0:	5d                   	pop    %ebp
80106bd1:	e9 0a fb ff ff       	jmp    801066e0 <deallocuvm.part.0>
...
80106c09:	e8 d2 fa ff ff       	call   801066e0 <deallocuvm.part.0>
...
80106c5c:	68 3d 79 10 80       	push   $0x8010793d
...
80106cab:	e8 a0 f9 ff ff       	call   80106650 <mappages>
...
80106d2f:	68 4e 79 10 80       	push   $0x8010794e
...
80106e19:	68 72 79 10 80       	push   $0x80107972
80106e1e:	e8 6d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e23:	83 ec 0c             	sub    $0xc,%esp
80106e26:	68 58 79 10 80       	push   $0x80107958
...
80106f10 <create_share_mem>:


int create_share_mem(char * addr){//TODO: convert panics to return -1;
...
80106f14:	83 ec 04             	sub    $0x4,%esp
  ...
  if(share_mem_pa == 0){
80106f17:	8b 1d c0 a5 10 80    	mov    0x8010a5c0,%ebx
80106f1d:	85 db                	test   %ebx,%ebx
80106f1f:	74 2f                	je     80106f50 <create_share_mem+0x40>

  }
  
  //cprintf("share_mem_pa is %d addr mapped is %d \n", (int) share_mem_pa, (int)addr);

  if(mappages(myproc()->pgdir, addr, PGSIZE, (uint) share_mem_pa, PTE_U | PTE_W) < 0){
80106f21:	e8 ca c8 ff ff       	call   801037f0 <myproc>
80106f26:	83 ec 08             	sub    $0x8,%esp
80106f29:	8b 40 04             	mov    0x4(%eax),%eax
80106f2c:	8b 55 08             	mov    0x8(%ebp),%edx
80106f2f:	6a 06                	push   $0x6
80106f31:	53                   	push   %ebx
80106f32:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f37:	e8 14 f7 ff ff       	call   80106650 <mappages>
80106f3c:	83 c4 10             	add    $0x10,%esp
80106f3f:	c1 f8 1f             	sar    $0x1f,%eax
  //cprintf("write iter is %d\n" ,*((int*)(P2V(share_mem_pa) + 4092)));

  //cprintf("my pid is %d", myproc()->pid);
  //cprintf("write iter is %d\n", *((int*)(share_mem_pa + 4092)));
  return 0;
}
...
80106f49:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    cprintf("had to kalloc a new page\n");
80106f50:	83 ec 0c             	sub    $0xc,%esp
80106f53:	68 8c 79 10 80       	push   $0x8010798c
80106f58:	e8 03 97 ff ff       	call   80100660 <cprintf>
    if((share_mem_pa = kalloc()) == 0){
80106f5d:	e8 6e b5 ff ff       	call   801024d0 <kalloc>
80106f62:	83 c4 10             	add    $0x10,%esp
80106f65:	85 c0                	test   %eax,%eax
80106f67:	a3 c0 a5 10 80       	mov    %eax,0x8010a5c0
80106f6c:	74 2c                	je     80106f9a <create_share_mem+0x8a>
    for(int i = 4080; i < 4096;i++){
80106f6e:	ba f0 0f 00 00       	mov    $0xff0,%edx
80106f73:	90                   	nop
80106f74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *(share_mem_pa + i) = 0; 
80106f78:	c6 04 10 00          	movb   $0x0,(%eax,%edx,1)
    for(int i = 4080; i < 4096;i++){
80106f7c:	83 c2 01             	add    $0x1,%edx
80106f7f:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
80106f84:	81 fa 00 10 00 00    	cmp    $0x1000,%edx
80106f8a:	75 ec                	jne    80106f78 <create_share_mem+0x68>
    share_mem_pa = (char*)V2P(share_mem_pa);
80106f8c:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
80106f92:	89 1d c0 a5 10 80    	mov    %ebx,0x8010a5c0
80106f98:	eb 87                	jmp    80106f21 <create_share_mem+0x11>
      return -1;
80106f9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f9f:	eb a1                	jmp    80106f42 <create_share_mem+0x32>
